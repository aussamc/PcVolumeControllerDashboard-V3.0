...
| `Computer_Volume_Controller_v2.27/` | Arduino | Current ESP32 firmware (`.ino`). `v2.26/`/`v2.25/`/`v2.24/` kept for reference. |
...
## Serial protocol (firmware v2.27)
...
- Dashboard version: **3.19.3** (Avalonia host). Required controller protocol: **2.24**
